    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="attendance">
                    <a href="#attendance">Attendance</a>
                                    ...
                                    <ul id="tocify-subheader-attendance" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="attendance-POSTapi-attendance-check-in">
                                <a href="#attendance-POSTapi-attendance-check-in">Check In</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="attendance-POSTapi-attendance-check-out">
                                <a href="#attendance-POSTapi-attendance-check-out">Check Out</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-GETapi-me">Get User Profile</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="employee">
                    <a href="#employee">Employee</a>
                                    ...
                                    <ul id="tocify-subheader-employee" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="employee-GETapi-employee-profile">
                                <a href="#employee-GETapi-employee-profile">Get Employee Detail</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="employee-GETapi-employee-payslips">
                                <a href="#employee-GETapi-employee-payslips">Get Payslips</a>
                            </li>
                                                                        </ul>
                            </ul>
                    <ul id="tocify-header-leaves" class="tocify-header">
                <li class="tocify-item level-1" data-unique="leaves">
                    <a href="#leaves">Leaves</a>
                </li>
                                    <ul id="tocify-subheader-leaves" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="leaves-GETapi-leaves">
                                <a href="#leaves-GETapi-leaves">List Leaves</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="leaves-POSTapi-leaves">
                                <a href="#leaves-POSTapi-leaves">Request Leave</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>API documentation for PayPay ERP Employee Portal and Mobile App</p>
<aside>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="attendance">Attendance</h1>
                                ...
                                <h2 id="attendance-POSTapi-attendance-check-in">Check In</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Record a check-in for the current day.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="attendance-POSTapi-attendance-check-out">Check Out</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Record a check-out for the current day.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://127.0.0.1:8000/api/attendance/check-out" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="authentication-GETapi-me">Get User Profile</h2>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="employee">Employee</h1>
                                ...
                                <h2 id="employee-GETapi-employee-profile">Get Employee Detail</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Get the employee profile associated with the authenticated user.</p>

<span id="example-requests-GETapi-employee-profile">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/employee/profile" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-GETapi-employee-profile">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-employee-profile" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-employee-profile"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-employee-profile"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-employee-profile" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-employee-profile">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-employee-profile" data-method="GET"
      data-path="api/employee/profile"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-employee-profile', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-employee-profile"
                    onclick="tryItOut('GETapi-employee-profile');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-employee-profile"
                    onclick="cancelTryOut('GETapi-employee-profile');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-employee-profile"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/employee/profile</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-employee-profile"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-employee-profile"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="employee-GETapi-employee-payslips">Get Payslips</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Get a list of payslips for the authenticated employee.</p>

<span id="example-requests-GETapi-employee-payslips">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/employee/payslips" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/employee/payslips"
);
...
<span id="example-responses-GETapi-employee-payslips">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-employee-payslips" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-employee-payslips"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-employee-payslips"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-employee-payslips" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-employee-payslips">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-employee-payslips" data-method="GET"
      data-path="api/employee/payslips"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-employee-payslips', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-employee-payslips"
                    onclick="tryItOut('GETapi-employee-payslips');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-employee-payslips"
                    onclick="cancelTryOut('GETapi-employee-payslips');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-employee-payslips"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/employee/payslips</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-employee-payslips"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-employee-payslips"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="leaves">Leaves</h1>

    

                                <h2 id="leaves-GETapi-leaves">List Leaves</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Get a list of leave requests for the authenticated employee.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="leaves-POSTapi-leaves">Request Leave</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="type"                data-endpoint="POSTapi-leaves"
               value="sick"
               data-component="body">
    <br>
<p>The type of leave (e.g., 'annual', 'sick'). Example: <code>sick</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>date</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The start date. Example: <code>2025-12-10</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>date</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The end date. Example: <code>2025-12-11</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The reason for leave. Example: <code>Flu</code></p>
        </div>
        </form>
